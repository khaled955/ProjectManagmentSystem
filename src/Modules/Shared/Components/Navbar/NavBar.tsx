      ...
      <div className="row align-items-center">
        ...
        <div className="col-sm-10 d-flex justify-content-end gap-2 align-items-center">
          ...
          <div className="avatar">
            <img className="rounded-circle" style={{width:25}} src={avatar} alt="Avatar img" />
          </div>
          <div className="login-data">
            <h5 className="h6 mb-0">{tokenDecoded?.userName}</h5>
            <p className="fw-light">{tokenDecoded?.userEmail}</p>
          </div>
        </div>
      </div>
